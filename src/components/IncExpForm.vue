      ...
      <form>
        <div class="form-group">
          ...
          <select class="form-control" v-model = "currentCategory" id="Category">
            ...
            <button type="button" class="btn btn-primary"  @click = "deleteCategory" id="deleteButton" > Delete Selected Category </button> <br/>            
            <label for="newCategoryName" v-if = "categoryBool" > New Category Name </label>
           <input type="text" class="form-control" v-if = "categoryBool" v-model = "newCategoryName" id="newCategoryName"> 
           <button type="button" class="btn btn-primary" v-if = "categoryBool" @click = "saveCategory" > Create Category </button> <br/>            
...
export default {
 ...
 data() {
  ...
  methods: {    
    ...
    saveCategory(){     
      this.$store.dispatch('add'+this.formType+'Category',{name: this.newCategoryName});
    },
    deleteCategory(){
      this.$store.dispatch('delete'+this.formType+'Category',this.currentCategory)
    },
    deleteForm(){
