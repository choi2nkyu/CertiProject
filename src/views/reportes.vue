    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <div>
          ...
          >Edit</b-button>
          <b-button variant="outline-danger" style="margin-left: 10px" @click="deleteIncome">Delete</b-button>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="row">
        ...
        <div>
          ...
          >Edit</b-button>
          <b-button variant="outline-danger" style="margin-left: 10px" @click="deleteExpense">Delete</b-button>
        </div>
      </div>
    </div>
  </div>
